...
from exp.exp_informer_modify import Exp_Informer


# 读取数据文件 增加代码23/4/25 yc
folder_path = './data'
extension = '.csv'
...
for i,j in zip(dir2, dir4):
    ...
    # if args.data not in exp._get_data(j,True).data_dict.key():
    #     exp._get_data(j,True).data_dict.update({j:"Dataset_Custom"})
        # print(Exp_Informer._get_data(self=args.data,flag=True).data_dict)
